...
class Meteor(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if self.rect.top > HEIGHT + 10 or self.rect.left < -40 or self.rect.right > WIDHT + 40:
            self.rect.x = random.randrange(WIDHT - self.rect.width)
...
def show_go_screen():
     ...
     draw_text(screen, "spacecraft", 65, WIDHT // 2, HEIGHT // 4)
     draw_text(screen, "todo pasa en la galaxia", 27, WIDHT // 2, HEIGHT //2)
     draw_text(screen, "presiona cualquier tecla", 20, WIDHT // 2, HEIGHT * 3/4)
     pygame.display.flip()
     waiting = True
     while waiting:
          clock.tick(60)
